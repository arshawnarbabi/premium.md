...
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE) ![Version](https://img.shields.io/badge/version-1.5.1-green) ![Status](https://img.shields.io/badge/status-stable-brightgreen)
...
All templates carry `template_version: "1.5.1"` in their YAML frontmatter. Per-project instances should preserve this field — when the template family evolves, projects can track which version they were authored against.

This release: **v1.5.1** — stable. Future updates follow [semantic versioning](https://semver.org/).
