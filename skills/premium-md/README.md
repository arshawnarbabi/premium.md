# premium-md — Agent Skill

The **premium.md** system packaged as a cross-tool [Agent Skill](https://agentskills.io) (`SKILL.md`, the open standard). It works in Claude Code, Codex, Gemini CLI, Cursor, Copilot, and other tools that read the standard.
