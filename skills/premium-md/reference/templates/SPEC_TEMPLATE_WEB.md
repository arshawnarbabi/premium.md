...
`template_version: 1.21.0`. Per-project `SPEC.md` instances should preserve this field.

# Source

Part of the `premium.md` family. Companion files: `PROJECT.md` (orchestration), `DESIGN.md` (visual system), `INFORMATION.md` (brand / business context).
