...
Part of the `premium-website-templates` family. Companion files: `PROJECT.md` (orchestration), `DESIGN_MOBILE.md` (visual system), `INFORMATION.md` (brand / business context), `SPEC.md` (web sibling — for projects that ship both).
