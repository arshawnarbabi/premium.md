...
This template is part of the `premium-website-templates` family. Companion files: `PROJECT.md` (orchestration), `DESIGN.md` / `DESIGN_MOBILE.md` (visual system), `SPEC.md` / `SPEC_MOBILE.md` (content + layout per page/screen).
