...
- ⏳ Next: Tier-1 #2 QA checklist → #3 SEO/AEO (incl. responsiveness, see §10) → #4 content model; then Tier-2.

## 10. Follow-up topics raised by the user (to fold into the build)
- **AEO (Answer Engine Optimization)** + **responsiveness / multi-device** — assess current coverage in `research.md` + DESIGN templates, research, and fold into the SEO/discoverability (AEO overlaps F5 heavily) and responsive work. *(assessment appended below as it happens.)*
