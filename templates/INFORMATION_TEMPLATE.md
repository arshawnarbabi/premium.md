...
`template_version: 1.16.0`. Per-project `INFORMATION.md` instances should preserve this field so you can track which template version they were authored against.
