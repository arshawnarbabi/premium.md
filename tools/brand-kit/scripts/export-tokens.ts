...
const dt: any = { color: {}, fontFamily: {}, spacing: {}, radius: {} };
for (const p of PALETTES) {
  dt.color[p] = {};
...
console.log(`  tokens.json  (DTCG: ${PALETTES.length} palettes, ${Object.keys(fams).length} fonts, ${Object.keys(spacing).length} spacing, ${Object.keys(radii).length} radii)`);
